...
class MerchantController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('merchants.index')->with('success', 'Поставщик успешно создан!');
    }
    ...
    public function update(Request $request, Merchant $merchant)
    {
        ...
        return redirect()->route('merchants.index')->with('success', 'Поставщик успешно обновлен!');
    }
