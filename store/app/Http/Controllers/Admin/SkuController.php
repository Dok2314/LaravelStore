...
class SkuController extends Controller
{
    ...
    public function store(SkuRequest $request, Product $product)
    {
        ...
        return redirect()->route('skus.index', $product)->with('success', 'Свойство для продукта "' . $product->name . '" успешно добавлено!');
    }
    ...
    {
        return view('auth.skus.show', compact('sku'));
    }
    ...
    public function update(Request $request, Product $product, Sku $sku)
    {
        ...
        return redirect()->route('skus.index', $product)->with('success', 'Свойство для продукта "' . $product->name . '" успешно обновлено!');
    }
    ...
    {
        session()->flash('success', 'Свойство для товара "' . $product->name . '" успешно удалено');
